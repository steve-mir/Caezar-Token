...
import com.example.caezar.activities.MiningActivity;
...
public class TokenFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.SHACard).setOnClickListener(v -> startActivity(new Intent(getContext(), MiningActivity.class)));
    }
