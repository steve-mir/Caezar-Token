 ...
 * Use the {@link NFTFragment#newInstance} factory method to
...
public class NFTFragment extends Fragment {
    ...
    public static NFTFragment newInstance(String param1, String param2) {
        NFTFragment fragment = new NFTFragment();
